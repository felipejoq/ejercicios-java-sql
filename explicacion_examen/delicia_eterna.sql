...
INSERT INTO `COLABORADOR` (`rutColaborador`, `nombre`, `primerApellido`, `segundoApellido`, `direccion`, `comuna`, `telefono`, `rol`, `idSucursal`) VALUES
...
INSERT INTO `PRODUCTO` (`idProducto`, `nombreProducto`, `descripcion`, `precio`, `idCategoriaProducto`) VALUES
...
INSERT INTO `stock` (`idProducto`, `idSucursal`, `stock`, `idAdministrador`) VALUES
(1, 1, 5, 1),
(1, 2, 44, 1),
(1, 3, 22, 1),
(1, 4, 28, 1),
...
INSERT INTO `VENTA` (`idVenta`, `idSucursal`, `rutCliente`, `idAdministrador`, `fecha`) VALUES
...
--
ALTER TABLE `COLABORADOR`
  ADD CONSTRAINT `colaborador_ib1` FOREIGN KEY (`idSucursal`) REFERENCES `SUCURSAL` (`idSucursal`);

--
-- Filtros para la tabla `PRODUCTO`
--
ALTER TABLE `PRODUCTO`
  ADD CONSTRAINT `producto_ib1` FOREIGN KEY (`idCategoriaProducto`) REFERENCES `CATEGORIA_PRODUCTO` (`idCategoriaProducto`);

--
-- Filtros para la tabla `stock`
--
ALTER TABLE `stock`
  ADD CONSTRAINT `stock_ib1` FOREIGN KEY (`idProducto`) REFERENCES `PRODUCTO` (`idProducto`),
  ADD CONSTRAINT `stock_ib2` FOREIGN KEY (`idSucursal`) REFERENCES `SUCURSAL` (`idSucursal`),
  ADD CONSTRAINT `stock_ib3` FOREIGN KEY (`idProducto`) REFERENCES `PRODUCTO` (`idProducto`),
  ADD CONSTRAINT `stock_ib4` FOREIGN KEY (`idAdministrador`) REFERENCES `ADMINISTRADOR` (`idAdministrador`);

--
-- Filtros para la tabla `VENTA`
--
ALTER TABLE `VENTA`
  ADD CONSTRAINT `venta_ib1` FOREIGN KEY (`idSucursal`) REFERENCES `SUCURSAL` (`idSucursal`),
  ADD CONSTRAINT `venta_ib2` FOREIGN KEY (`rutCliente`) REFERENCES `CLIENTE` (`rutCliente`),
  ADD CONSTRAINT `venta_ib3` FOREIGN KEY (`idAdministrador`) REFERENCES `ADMINISTRADOR` (`idAdministrador`);
COMMIT;
